...
const char* topic1 = "DEPARTMENT_KEAN";
const char* topic2 = "NAME_KEAN";
const char* mqtt_username = "KEAN";
...
void loop() {
    ...
    String payload1 = "COMPUTER ENGINEERING ";
    String payload2 = "PATTARAPONG";
